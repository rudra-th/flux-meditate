import {
  ...
  useOnMount,
  useTimeout
} from "./chunk-OIBGINEP.js";
import {
  useLazyRef,
  useReducedMotion
} from "./chunk-4WYVEAJ5.js";
import {
  elementTypeAcceptingRef_default,
  refType_default
} from "./chunk-G22XDJ6X.js";
import {
  useForkRef_default
} from "./chunk-EI2HVKPX.js";
import {
  useTheme
...
function Ripple(props) {
  ...
  const exitTimerStartedRef = React4.useRef(false);
  const onExitedRef = React4.useRef(onExited);
...
var TouchRipple = React5.forwardRef(function TouchRipple2(inProps, ref) {
  ...
  const [rippleState, setRippleState] = React5.useState({
    items: EMPTY_ARRAY,
    order: EMPTY_ARRAY
  });
  ...
  const mountedRef = React5.useRef(false);
  useOnMount(() => {
  ...
  return (0, import_jsx_runtime2.jsx)(TouchRippleRoot, {
    ...
    ref: container,
    ...other,
    children: orderedRipples.map((ripple) => (0, import_jsx_runtime2.jsx)(TouchRippleRipple, {
      classes: {
...
//# sourceMappingURL=chunk-7XIVLYSQ.js.map
